 ...
 */
 ...
 //This is the fifo6
 fifo_pong_chu fifo_6_inst(.clk(kpn_clk), .rd(lcd_rd),
 .wr(adder_2_wr), .entry_1(adder_2_output), .output_1(fifo_6_output));
 ...
 bcd_converter bcd_converter_inst(.clk(kpn_clk), .binary_number(fifo_6_output), .bcd_number(bcd_output));
